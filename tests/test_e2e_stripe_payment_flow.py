...
from tests.test_stripe import do_handle_payment_intent_webhook
...
def validate_calculations(merchant_transaction_id, expectations):
...
def test_e2e_normal_transaction_flow(client):
    ...
    merchant_list.append(generate_merchant(client, connect_account_p=1, default_currency_id=1, default_country_id=1, commission_paid_by_merchant_p=0, default_tip=0))
    merchant_list.append(generate_merchant(client, connect_account_p=1, default_currency_id=1, default_country_id=1, commission_paid_by_merchant_p=0, default_tip=1))
    merchant_list.append(generate_merchant(client, connect_account_p=1, default_currency_id=1, default_country_id=1, commission_paid_by_merchant_p=1, default_tip=0))
    merchant_list.append(generate_merchant(client, connect_account_p=1, default_currency_id=1, default_country_id=1, commission_paid_by_merchant_p=1, default_tip=1))
    ...
    merchant_list.append(generate_merchant(client, connect_account_p=1, default_currency_id=54, default_country_id=4, commission_paid_by_merchant_p=0, default_tip=0))
    merchant_list.append(generate_merchant(client, connect_account_p=1, default_currency_id=54, default_country_id=4, commission_paid_by_merchant_p=0, default_tip=1))
    merchant_list.append(generate_merchant(client, connect_account_p=1, default_currency_id=54, default_country_id=4, commission_paid_by_merchant_p=1, default_tip=0))
    merchant_list.append(generate_merchant(client, connect_account_p=1, default_currency_id=54, default_country_id=4, commission_paid_by_merchant_p=1, default_tip=1))

    """
    Correct 'item_list' so sum of all prices match 'payable_amount'
    """
    test_file_list = [
        "tests/testdata/payment_link_generation_payload/stripe/correct/00_no_item_breakdown.json",
        "tests/testdata/payment_link_generation_payload/stripe/correct/01_menu_items_only.json",
        "tests/testdata/payment_link_generation_payload/stripe/correct/02_menu_items_with_modifiers.json",
        "tests/testdata/payment_link_generation_payload/stripe/correct/03_offers_only.json",
        "tests/testdata/payment_link_generation_payload/stripe/correct/04_offers_with_items_and_modifiers.json",
        "tests/testdata/payment_link_generation_payload/stripe/correct/05_all_item_types.json",
        "tests/testdata/payment_link_generation_payload/stripe/correct/06_all_item_types_for_payment_point.json"
    ]
    ...
    for one_merchant in merchant_list:
        ...
        for one_test_file in test_file_list:
            ...
            # payment request initiated
            with open(f'tests/testdata/stripe/normal/sample_payment_succeeded_webhook_response.json') as f:
                sample_payment_request_webhook_response = json.load(f)
                sample_payment_request_webhook_response["data"]["object"]["id"] = stripe_intent_reference_number
                sample_payment_request_webhook_response["data"]["object"]["amount"] = validated_calculations["new_payable_amount"] * 100
...
# --------- Payment-Link Cancelled Flow ---------- #
    ...
    """
    file_name = "tests/testdata/payment_link_generation_payload/stripe/incorrect_menu_items_only.json"
